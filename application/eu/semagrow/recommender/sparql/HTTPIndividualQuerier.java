 ...
 *
 */
public class HTTPIndividualQuerier {

	private final static Logger log = Logger.getLogger(HTTPIndividualQuerier.class.getName());
	 ...
	 */
	public HTTPIndividualQuerier(String sourceURI){
